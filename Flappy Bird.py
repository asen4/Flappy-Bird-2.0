...
# Declare all the game variables.
window_width = 600
window_height = 499
...
game_images = {}
framepersecond = 32
pipeimage = 'Flappy Bird Images 2/pipe.png'
background_image = 'Flappy Bird Images 2/background.jpg'
birdplayer_image = 'Flappy Bird Images 2/bird.png'
sealevel_image = 'Flappy Bird Images 2/base.jfif'
...
def flappygame():
    ...
    # A list containing the upper pipes.
    up_pipes = [
        {'x': window_width+300-mytempheight,
        'y': first_pipe[0]['y']},
    ...
    # Pipe velocity along x-direction.
    pipeVelX = -4
    ...
    while True:
        ...
        # This function will return true if the bird is crashed.
...
if __name__ == "__main__":
    ...
    game_images['scoreimages'] = (
        pygame.image.load('Flappy Bird Images 2/0.png').convert_alpha(),
        pygame.image.load('Flappy Bird Images 2/1.png').convert_alpha(),
        pygame.image.load('Flappy Bird Images 2/2.png').convert_alpha(),
        pygame.image.load('Flappy Bird Images 2/3.png').convert_alpha(),
        pygame.image.load('Flappy Bird Images 2/4.png').convert_alpha(),
        pygame.image.load('Flappy Bird Images 2/5.png').convert_alpha(),
        pygame.image.load('Flappy Bird Images 2/6.png').convert_alpha(),
        pygame.image.load('Flappy Bird Images 2/7.png').convert_alpha(),
        pygame.image.load('Flappy Bird Images 2/8.png').convert_alpha(),
        pygame.image.load('Flappy Bird Images 2/9.png').convert_alpha()
    )
